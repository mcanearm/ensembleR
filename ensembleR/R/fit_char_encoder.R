...
#' @export
#' @param X The covariate features. Expects a data.frame format, since the
#' function is searching for character columns.
#' @description
...
#' @param object A char_encoder object, consistent with the predict interface.
#' @param ... Unused ellipsis argument. Added for consistency with `predict`
#' interface.
