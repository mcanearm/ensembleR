...
```{r}
abalone <- read.csv("C:/Users/ASUS/Desktop/BIO615/Group Project/abalone.csv", header = TRUE)

# Test the function
abalone_models <- fit_models(abalone)

# Check models
abalone_models$lm_model  # View Linear Regression model
abalone_models$rf_model  # View Random Forest model
abalone_models$xgb_model # View XGBoost model
abalone_models$svm_model # View SVM model
```